...
import convertMainExport from './convert-main-export.mjs'
import convertDIInstantiation from './convert-di-instantiation.mjs'
import resolveConfig from './resolve-config.mjs'

const acornParser = Parser.extend(jsx({ allowNamespacedObjects: true }))
